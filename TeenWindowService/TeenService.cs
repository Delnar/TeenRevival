...
namespace TeenWindowService
{
    public partial class TeenService : ServiceBase
    {
        ...
        public void StartHTTPService()
        {
            ...
            // netsh http add urlacl url = http://+:8000/TeenService user=Joshua
            // netsh http add urlacl url = http://+:8001/TeenService user=Joshua

            _HTTPserviceHost = new System.ServiceModel.Web.WebServiceHost(new wcfTeenService.wcf.TeenService());
        ...
        public void StopHTTPService()
        {
            if (_HTTPserviceHost != null)
            {
                wcfTeenService.Settings.FinalizeSettings();
                _HTTPserviceHost.Close();
                _HTTPserviceHost = null;
            }
        }
        ...
        public void StartWebHost()
        {
            ...
            _WebHost = new NancyHost(new Uri(URL), new Nancy.BootStrapper(), hostConfig );
            _WebHost.Start();
        }
