...
namespace wcfTeenService.wcf.Extensions
{
    static public class Extensions
    {
        ...
        static public void FillFromDataBase(this List<TeenRecord> r)
        {
            ...
            try
            {
                var lstTeenRecs = DataClasses.Teen.GetAllTeens().Select(x => new TeenRecord(x));
                lstTeenRecs.ToList().ForEach(rec => {                    
                    r.Add(rec);
                });                
            }
            catch (Exception ex)
        ...
        //static public void FillFromDataBaseEE(this List<TeenRecord> r)
        //{
        //    try
        //    {
        //        using (var db = Code.TeenDataHelper.GetEE())
